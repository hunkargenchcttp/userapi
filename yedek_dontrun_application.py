# Bu python çalışması ilk çalışmadır.
# Bu dosyayı yedek olarak kullandım.
# Projenin 1. kısmı client.py, 2. kısmı server.py'da ele alınmıştır.
...
app.config["SQLALCHEMY_DATABASE_URI"]='postgresql:///@localhost/userapi'
...
def index():
    if request.method == "GET":
        ...
        for _ in range(10):
            ...
            fake_data = data.append(response)

            json_object = json.loads(fake_data)
